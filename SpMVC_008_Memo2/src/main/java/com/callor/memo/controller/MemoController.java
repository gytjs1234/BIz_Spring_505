...
public class MemoController {
	...
	public String memo(@ModelAttribute("memo") MemoDTO memo, HttpSession httpSession) {
	...
	/*
	 * 첨부파일이 있는 프로젝트에서 form의 input box 의 이름은 절대 VO(DTO) 클래스에 선언된 이름을 사용하면 안된다
	 */
	...
	public String update(@PathVariable("seq")String seq, @ModelAttribute("memo")MemoDTO memoDTO,MultipartFile file,HttpSession httpSession) {
		...
		//주소에 따라온 seq변수 값을 추출하여 memoDTO 에 setting 하기
		long m_seq =Long.valueOf(seq);
