...
public class StudentController {
	 ...
	 * studenetController.setstService(stService);
	 * 
	 *보통 Autowired 를 사용한 Setter 주입 방식을 사용하는데 Setter 주입방식에서는 메로리 릭(leak,누수)가 발생하기도 한다
	 *최근에슨 생성자 주입방식을 적극 권장 하고있다.
	 */
	@Autowired
	...
	/*
	 * form 에서 input담긴 데이터를 수신하는 method
	 */
